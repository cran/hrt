...
RcppExport SEXP _hrt_rrank(SEXP ASEXP, SEXP tolSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _hrt_rkernel(SEXP ASEXP, SEXP tolSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Eigen::MatrixXd >::type A(ASEXP);
...
RcppExport SEXP _hrt_ctest(SEXP umatSEXP, SEXP RbmatSEXP, SEXP WvecSEXP, SEXP BmatSEXP, SEXP coresSEXP, SEXP tolSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_hrt_rrank", (DL_FUNC) &_hrt_rrank, 2},
    {"_hrt_rkernel", (DL_FUNC) &_hrt_rkernel, 2},
    {"_hrt_ctest", (DL_FUNC) &_hrt_ctest, 6},
    {NULL, NULL, 0}
};

RcppExport void R_init_hrt(DllInfo *dll) {
